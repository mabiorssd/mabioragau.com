...
export const HeroSection = ({ text, showCursor }: HeroSectionProps) => {
  return (
    <section id="about" className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 relative">
      <div className="max-w-5xl mx-auto text-center">
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 text-green-400">
          MABIOR AGAU
        </h1>

        <div className="text-xl sm:text-2xl text-green-300 mb-6">
          {text}
